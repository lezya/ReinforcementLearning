...
class GridWorld(object):
    def __init__(self, m, n, magicSquares):
        ...
        self.stateSpace.remove(self.m*self.n-1)       #state space do not include the terminal State, it is included only in the complete state space or StateSpace+
    ...
    def __setstate__(self, state):    ##changed the code, to be checked
    ...
    def step(self, action):
        ...
        if not self.offGridMove(resultingState, self.agentPosition):
            self.__setstate__(resultingState)
